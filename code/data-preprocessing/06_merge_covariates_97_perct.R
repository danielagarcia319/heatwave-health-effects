...
load("heatwave-health-effects/data/matched_dataset_97_hosp.Rdata")

# Load aggregated denom data
load("heatwave-health-effects/data/denom_agg.Rdata")

# Merge covariates to 97 percentile matched data
if (perct == 97) {
  merged_dataset_97 <- matched_dataset_97_hosp %>%
...
# Impute missing data 
if (perct == 97) {
  final_dataset_97 <- merged_dataset_97 %>%
...
save(final_dataset_97, file = "heatwave-health-effects/data/final_dataset_97.Rdata")
