...
# get quantile breaks
breaks_hosp <- classIntervals(plot_hosp_count$total_hosp, n = 5, style = "quantile")

# put counts into buckets
plot_hosp_count$hosp_cat <- cut(plot_hosp_count$total_hosp, breaks_hosp$brks, include.lowest = TRUE, dig.lab = 6)

# Plot
jpeg(paste0("heatwave-health-effects/figures/maps/hosp_map_all_years_", perct,"_perct.jpg"),
